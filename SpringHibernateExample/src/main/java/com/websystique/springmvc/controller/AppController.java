...
import com.websystique.springmvc.service.MyService;
import com.websystique.springmvc.util.StaticValues;
...
public class AppController {
	...
	public String listEmployees(ModelMap model) {
		...
		System.out.println(staticValues.getName());
		System.out.println(testService.addition(10, 20));
